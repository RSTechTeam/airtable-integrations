...
import Url from 'url';
import require$$0$4 from 'punycode';
...
import Stream$1, { PassThrough as PassThrough$2, pipeline as pipeline$1 } from 'node:stream';
...
function requireURL () {
	...
	(function (module) {
		...
		const conversions = /*@__PURE__*/ requireLib$1();
...
function requirePublicApi () {
	...
	publicApi.URL = /*@__PURE__*/ requireURL().interface;
	publicApi.serializeURL = /*@__PURE__*/ requireUrlStateMachine().serializeURL;
	publicApi.serializeURLOrigin = /*@__PURE__*/ requireUrlStateMachine().serializeURLOrigin;
	publicApi.basicURLParse = /*@__PURE__*/ requireUrlStateMachine().basicURLParse;
	publicApi.setTheUsername = /*@__PURE__*/ requireUrlStateMachine().setTheUsername;
	publicApi.setThePassword = /*@__PURE__*/ requireUrlStateMachine().setThePassword;
	publicApi.serializeHost = /*@__PURE__*/ requireUrlStateMachine().serializeHost;
	publicApi.serializeInteger = /*@__PURE__*/ requireUrlStateMachine().serializeInteger;
	publicApi.parseURL = /*@__PURE__*/ requireUrlStateMachine().parseURL;
	return publicApi;
}
			...
			if (fetch$3.isRedirect(res.statusCode)) {
				...
				switch (request.redirect) {
					...
					case 'follow':
						...
						resolve(fetch$3(new Request$2(locationURL, requestOpts)));
						finalize();
						return;
				}
			}
...
var require$$0$3 = /*@__PURE__*/getAugmentedNamespace(lib$1);

var fetch$2;
var hasRequiredFetch;

function requireFetch () {
	if (hasRequiredFetch) return fetch$2;
	hasRequiredFetch = 1;
	var __importDefault = (fetch$2 && fetch$2.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	// istanbul ignore file
	var node_fetch_1 = __importDefault(require$$0$3);
	fetch$2 = typeof window === 'undefined' ? node_fetch_1.default : window.fetch.bind(window);
...
var require$$0$2 = /*@__PURE__*/getAugmentedNamespace(abortController$1);

var cjsPonyfill = {};

var hasRequiredCjsPonyfill;

function requireCjsPonyfill () {
	if (hasRequiredCjsPonyfill) return cjsPonyfill;
	hasRequiredCjsPonyfill = 1;
	...
	cjsPonyfill.AbortController = AbortController;
	cjsPonyfill.AbortSignal = AbortSignal;
...
function requireAbortController () {
	if (hasRequiredAbortController) return abortController;
	hasRequiredAbortController = 1;
	// istanbul ignore file
	var AbortController;
	if (typeof window === 'undefined') {
	    AbortController = require$$0$2;
	}
	    ...
	    var polyfill = /*@__PURE__*/ requireCjsPonyfill();
...
var object_to_query_param_string;
var hasRequiredObject_to_query_param_string;

function requireObject_to_query_param_string () {
	if (hasRequiredObject_to_query_param_string) return object_to_query_param_string;
	hasRequiredObject_to_query_param_string = 1;
	var __importDefault = (object_to_query_param_string && object_to_query_param_string.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var isArray_1 = __importDefault(/*@__PURE__*/ requireIsArray());
	var isNil_1 = __importDefault(/*@__PURE__*/ requireIsNil());
	var keys_1 = __importDefault(/*@__PURE__*/ requireKeys());
	...
	object_to_query_param_string = objectToQueryParamString;
	
	return object_to_query_param_string;
}

var airtable_error;
var hasRequiredAirtable_error;

function requireAirtable_error () {
	if (hasRequiredAirtable_error) return airtable_error;
	hasRequiredAirtable_error = 1;
...
var deprecate_1;
var hasRequiredDeprecate;

function requireDeprecate () {
	if (hasRequiredDeprecate) return deprecate_1;
	hasRequiredDeprecate = 1;
...
var callback_to_promise;
var hasRequiredCallback_to_promise;

function requireCallback_to_promise () {
	if (hasRequiredCallback_to_promise) return callback_to_promise;
	hasRequiredCallback_to_promise = 1;
	/**
...
function requireRecord () {
	...
	hasRequiredRecord = 1;
	var __assign = (record && record.__assign) || function () {
	...
	var __importDefault = (record && record.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var callback_to_promise_1 = __importDefault(/*@__PURE__*/ requireCallback_to_promise());
...
var typecheck;
var hasRequiredTypecheck;

function requireTypecheck () {
	if (hasRequiredTypecheck) return typecheck;
	hasRequiredTypecheck = 1;
	/* eslint-enable @typescript-eslint/no-explicit-any */
...
var hasRequiredQuery_params;

function requireQuery_params () {
	if (hasRequiredQuery_params) return query_params;
	hasRequiredQuery_params = 1;
	var __importDefault = (query_params && query_params.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(query_params, "__esModule", { value: true });
	query_params.paramValidators = void 0;
	var typecheck_1 = __importDefault(/*@__PURE__*/ requireTypecheck());
	var isString_1 = __importDefault(/*@__PURE__*/ requireIsString());
	var isNumber_1 = __importDefault(/*@__PURE__*/ requireIsNumber());
	var isPlainObject_1 = __importDefault(/*@__PURE__*/ requireIsPlainObject());
	var isBoolean_1 = __importDefault(/*@__PURE__*/ requireIsBoolean());
	query_params.paramValidators = {
...
function requireQuery () {
	...
	hasRequiredQuery = 1;
	var __assign = (query && query.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
	...
	var __importDefault = (query && query.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var isFunction_1 = __importDefault(/*@__PURE__*/ requireIsFunction());
	var keys_1 = __importDefault(/*@__PURE__*/ requireKeys());
	var record_1 = __importDefault(/*@__PURE__*/ requireRecord());
	var callback_to_promise_1 = __importDefault(/*@__PURE__*/ requireCallback_to_promise());
	var has_1 = __importDefault(/*@__PURE__*/ requireHas());
	var query_params_1 = /*@__PURE__*/ requireQuery_params();
	/**
...
function requireTable () {
	...
	hasRequiredTable = 1;
	var __assign = (table && table.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
	...
	var __importDefault = (table && table.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var isPlainObject_1 = __importDefault(/*@__PURE__*/ requireIsPlainObject());
	var deprecate_1 = __importDefault(/*@__PURE__*/ requireDeprecate());
	var query_1 = __importDefault(/*@__PURE__*/ requireQuery());
	var record_1 = __importDefault(/*@__PURE__*/ requireRecord());
	var callback_to_promise_1 = __importDefault(/*@__PURE__*/ requireCallback_to_promise());
...
var http_headers;
var hasRequiredHttp_headers;

function requireHttp_headers () {
	if (hasRequiredHttp_headers) return http_headers;
	hasRequiredHttp_headers = 1;
	var __importDefault = (http_headers && http_headers.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var keys_1 = __importDefault(/*@__PURE__*/ requireKeys());
...
var exponential_backoff_with_jitter;
var hasRequiredExponential_backoff_with_jitter;

function requireExponential_backoff_with_jitter () {
	if (hasRequiredExponential_backoff_with_jitter) return exponential_backoff_with_jitter;
	hasRequiredExponential_backoff_with_jitter = 1;
	var __importDefault = (exponential_backoff_with_jitter && exponential_backoff_with_jitter.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var internal_config_json_1 = __importDefault(require$$0$1);
...
var package_version;
var hasRequiredPackage_version;

function requirePackage_version () {
	if (hasRequiredPackage_version) return package_version;
	hasRequiredPackage_version = 1;
	package_version = require$$0.version;
	/* eslint-enable @typescript-eslint/no-var-requires */
...
var run_action;
var hasRequiredRun_action;

function requireRun_action () {
	if (hasRequiredRun_action) return run_action;
	hasRequiredRun_action = 1;
	var __importDefault = (run_action && run_action.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var exponential_backoff_with_jitter_1 = __importDefault(/*@__PURE__*/ requireExponential_backoff_with_jitter());
	var object_to_query_param_string_1 = __importDefault(/*@__PURE__*/ requireObject_to_query_param_string());
	var package_version_1 = __importDefault(/*@__PURE__*/ requirePackage_version());
	var fetch_1 = __importDefault(/*@__PURE__*/ requireFetch());
	var abort_controller_1 = __importDefault(/*@__PURE__*/ requireAbortController());
...
function requireBase () {
	...
	hasRequiredBase = 1;
	var __assign = (base && base.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
	...
	var get_1 = __importDefault(/*@__PURE__*/ requireGet());
	var isPlainObject_1 = __importDefault(/*@__PURE__*/ requireIsPlainObject());
	var keys_1 = __importDefault(/*@__PURE__*/ requireKeys());
	var fetch_1 = __importDefault(/*@__PURE__*/ requireFetch());
	var abort_controller_1 = __importDefault(/*@__PURE__*/ requireAbortController());
	var object_to_query_param_string_1 = __importDefault(/*@__PURE__*/ requireObject_to_query_param_string());
	var airtable_error_1 = __importDefault(/*@__PURE__*/ requireAirtable_error());
	var table_1 = __importDefault(/*@__PURE__*/ requireTable());
	var http_headers_1 = __importDefault(/*@__PURE__*/ requireHttp_headers());
	var run_action_1 = __importDefault(/*@__PURE__*/ requireRun_action());
	var package_version_1 = __importDefault(/*@__PURE__*/ requirePackage_version());
	var exponential_backoff_with_jitter_1 = __importDefault(/*@__PURE__*/ requireExponential_backoff_with_jitter());
	var userAgent = "Airtable.js/" + package_version_1.default;
...
var airtable;
var hasRequiredAirtable;

function requireAirtable () {
	if (hasRequiredAirtable) return airtable;
	hasRequiredAirtable = 1;
	var __importDefault = (airtable && airtable.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	var base_1 = __importDefault(/*@__PURE__*/ requireBase());
	var record_1 = __importDefault(/*@__PURE__*/ requireRecord());
	var table_1 = __importDefault(/*@__PURE__*/ requireTable());
	var airtable_error_1 = __importDefault(/*@__PURE__*/ requireAirtable_error());
...
var airtableExports = /*@__PURE__*/ requireAirtable();
var Airtable = /*@__PURE__*/getDefaultExportFromCjs(airtableExports);
...
function requireLib () {
	...
	(function (exports$1) {
		...
		const pm = __importStar(/*@__PURE__*/ requireProxy());
		const tunnel = __importStar(/*@__PURE__*/ requireTunnel());
		var HttpCodes;
		(function (HttpCodes) {
...
function requirePathUtils () {
	...
	const path = __importStar(require$$0$7);
	/**
...
function batchAsync(func, array, size) {
  return Promise.all(Array.from(batch$1(array, size), func));
}
...
const log = coreExports.info;

/** @type {function(string)} */
const warn = coreExports.warning;
...
function getInput(input, required = true) {
  return lazyCache(() => coreExports.getInput(input, {required}));
}
...
function writeSummary() {
  if (summaryTableData.length > 0) {
    coreExports.summary.addTable(summaryTableData);
  }
...
/** @type function(): string */
const billSpendExpenseApiKey = getInput('bill-spend-expense-api-key');
...
async function fetch$1(url, options_) {
	return new Promise((resolve, reject) => {
		...
		request_.on('response', response_ => {
			...
			let body = pipeline$1(response_, new PassThrough$2(), error => {
				if (error) {
					reject(error);
				}
			});
			...
			// For gzip
			if (codings === 'gzip' || codings === 'x-gzip') {
				body = pipeline$1(body, zlib$1.createGunzip(zlibOptions), error => {
					if (error) {
						reject(error);
					}
				});
			...
			if (codings === 'deflate' || codings === 'x-deflate') {
				// Handle the infamous raw deflate response from old servers
				// a hack for old IIS and Apache servers
				const raw = pipeline$1(response_, new PassThrough$2(), error => {
					if (error) {
						reject(error);
					}
				});
				raw.once('data', chunk => {
					// See http://stackoverflow.com/questions/37519828
					if ((chunk[0] & 0x0F) === 0x08) {
						body = pipeline$1(body, zlib$1.createInflate(), error => {
							if (error) {
								reject(error);
							}
						});
					} else {
						body = pipeline$1(body, zlib$1.createInflateRaw(), error => {
							if (error) {
								reject(error);
							}
						});
			...
			// For br
			if (codings === 'br') {
				body = pipeline$1(body, zlib$1.createBrotliDecompress(), error => {
					if (error) {
						reject(error);
					}
				});
 ...
 * @see Window.fetch
 */
function fetch(getErrorObject, ...fetchArgs) {
  return retry(
      async () => {
        const response = await fetch$1(...fetchArgs);
