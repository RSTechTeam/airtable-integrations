...
await (0,_common_action_js__WEBPACK_IMPORTED_MODULE_3__/* .run */ .K)(async () => {
  ...
  const expenseRecords =
      (0,_common_sync_js__WEBPACK_IMPORTED_MODULE_4__/* .getMapping */ .tj)(await expenseSources.select(AMEX_TABLE), 'Reference');
      ...
      (results, parser) => {
        ...
        return Promise.all([
          expenseSources.update(
              AMEX_TABLE, Array.from(updates, _common_sync_js__WEBPACK_IMPORTED_MODULE_4__/* .airtableRecordUpdate */ .vw)),
...
/******/ var __webpack_exports__ = __nccwpck_require__(9326);
